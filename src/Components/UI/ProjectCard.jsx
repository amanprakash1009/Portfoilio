...
return ( <article className="h-full group"> <Card className="h-full bg-gray-900/40 text-card-foreground border-gray-700/50 hover:border-cyan-400/30 hover:bg-gray-800/30 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/10 backdrop-blur-sm">
